...
$template = array(
    'name'              => 'Sistema Informático: SIRAMA',
    'version'           => '1',
    'author'            => 'Estudio Agil',
    'robots'            => 'noindex, nofollow',
    'title'             => 'Sirama',
    'description'       => 'Sistema Informatico Administrativo de SIRAM',
...
if($_SESSION['nivel']=='1'){
    ...
    $primary_nav = array(
        ...
        array(
            ...
            'name'  => 'Cursos',
            'url'   => '../sirama_programas/ver_programas.php?date='.date("Yidisus"),
            'url_real' => 'ver_programas.php',
        ...
        array(
            ...
            'name'  => 'Alumnas',
            'url'   => '../sirama_alumnas/ver_alumnas.php?date='.date("Yidisus"),
            'url_real' => 'ver_alumnas.php',
            'icon'  => 'gi gi-girl'
        ...
        array(
            ...
            'name'  => 'Instructores',
            'url'   => '../sirama_instructores/ver_instructores.php?date='.date("Yidisus"),
            'url_real' => 'ver_instructores.php',
            'icon'  => 'gi gi-parents'

        ),
        array(

            'name'  => 'Personal SIRAMA',
        ...
        /*array(
            ...
            'sub'   => array(
                array(
                    'name'  => 'Nuevo Usuario',
                    'url'   => '../personas/principal_administrador.php?date='.date("Yidisus"),
                    'url_real'   => 'principal_administrador.php'
                ),
                array(
