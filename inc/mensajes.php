...
define("BIENVENIDO", "Bienvenido al sistema ");
define("USUARIO_INVALIDO", "El usuario ingresado no es valido ");
define("USUARIO_INACTIVO", "El usuario ingresado esta inactivo ");
...
define("MENSAJE_ELIMINAR_ALERT","<h3>¿Desea eliminar el dato seleccionado?</h3>");
define("MENSAJE_ELIMINAR_CONFIRMAR","<h3>¿Realmente desea eliminarlo?</h3>");
