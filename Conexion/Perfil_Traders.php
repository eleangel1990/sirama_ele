<?php 
	...
	*/
	class Perfil_Traders
	{
		...
		public static function retornar_nombre($identificador){
			$html="";
			$sql = "SELECT *from traders where id = '$identificador'";
			...
			try {
	                ...
	                <div class="block-section text-center">
			                    <a data-codigo="'.$codigo_oficina.'" id="cambiar_imagen" href="javascript:void(0)">
			                    ...
			                    <input data-codigo2="'.$codigo_oficina.'"  type="file" class="archivos hidden" id="file_2" name="file_2" />
